...
const CommentsContainer = () => {
    ...
    return (
        <div
            className={
                "comments-scroll-container max-sm:w-full fixed duration-700 max-sm:right-0 sm:top-0 w-[30%] min-w-[350px] h-full z-50 bg-white shadow-2xl p-8 px-16 overflow-y-auto overflow-x-hidden " +
                (commentsWrapper
                    ? " top-0 sm:right-0"
